        ...
        <>
            <div className="montserrat-font  h-full w-full flex flex-col p-10 space-y-10">
                ...
                <div className="flex items-start justify-end space-x-9  h-[10%]">
                    <button onClick={()=>{navigate("/myproperty ")}} className="hover:bg-green-700 hover:text-lg hover:text-white rounded-md border pl-10 pr-10 h-full w-[25%] "> Submit </button>
                </div>
            </div>   
        </>
    )
